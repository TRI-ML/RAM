...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--vis_vids', action='store_true')
    ...
    self.parser.add_argument('--num_vis_vids', type=int, default=5,
                             help='Number of videos to visualize at each validation step')
    ...
    self.parser.add_argument('--gru_filter_size', type=int, default=7)
    ...
    self.parser.add_argument('--variable_stride', action='store_true',
                             help='Use variable stride for video clips')
    ...
    self.parser.add_argument('--predicted_hm', action='store_true')
    ...
    self.parser.add_argument('--radius_growth_step', type=float, default=0.0,
                             help='increase heatmap radius at every occlusion step')
    ...
    self.parser.add_argument('--add_unmatched', action='store_true')
    self.parser.add_argument('--person_weight', type=int, default=1, help='')
    self.parser.add_argument('--ignore_wh_insym', action='store_true')
    self.parser.add_argument('--use_occl_len', action='store_true')
    self.parser.add_argument('--occl_len_mult', type=int, default=1, help='')
    self.parser.add_argument('--ignorevisininvis_batch', action='store_true')
    self.parser.add_argument('--no_temp_flip', action='store_true')
    self.parser.add_argument('--nu', action='store_true')
    self.parser.add_argument('--random_walk', action='store_true')
    self.parser.add_argument('--rw_weight', type=float, default=0.5,
                             help='')
    self.parser.add_argument('--rw_head_depth', type=int, default=0,
                             help='number of layers in rw head.')
    self.parser.add_argument('--rw_temp', type=float, default=0.05,
                             help='')
    self.parser.add_argument('--pool_kernel', type=int, default=3,
                             help='size of avg pool kernel used for featuremap downsampling.')
    self.parser.add_argument('--rw_score_thresh', type=float, default=0.05,
                             help='threshold for inference time crw tracking')
    self.parser.add_argument('--disocl_match_thresh', type=float, default=25,
                             help='distance threshold for matching crw localiztions to new detections')
    self.parser.add_argument('--border_thresh', type=float, default=0.05,
                             help='margin used to stop tracking object that are close to the image boundary')
    self.parser.add_argument('--local_rw_r', type=float, default=0.2,
                             help='')
    self.parser.add_argument('--local_rw_topk', type=int, default=0,
                             help='top k used by local random walk.')
    self.parser.add_argument('--sup_centeroverlap', action='store_true')
    self.parser.add_argument('--split_batch', action='store_true', default=False, help='')
    self.parser.add_argument('--sup_reg', action='store_true', default=False, help='supervise box center tracking head')
    self.parser.add_argument('--overlapmult', type=int, default=50)
    ...
    self.parser.add_argument('--max_out_age', type=int, default=1)
    self.parser.add_argument('--max_vids', type=int, default=0)
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    # if input_w == 480 and '17halfval' in opt.dataset_version:
    #   input_w *= 2
